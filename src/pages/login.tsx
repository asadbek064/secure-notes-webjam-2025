      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <Button className="w-full bg-[#5865F2] hover:bg-[#4752C4]" onClick={handleDiscordLogin}>
        ...
        <CardFooter className="flex flex-col items-center gap-2 pt-6 border-t">
          <div className="flex items-center gap-2">
            <img
              src="https://photos.mylinx.cc/JdT3izUJKGB9"
              alt="Creator"
              className="w-24 h-24 rounded-3xl object-cover"
            />
            <div className="text-sm text-muted-foreground">Created by Asad Karimov</div>
          </div>
          <div className="flex flex-wrap justify-center gap-2 text-sm text-muted-foreground">
            ...
            >
              mylinx.cc/asad <ExternalLink className="ml-1 w-3 h-3" />
            </a>
            <span>•</span>
            <a
              ...
              className="flex items-center hover:text-primary transition-colors"
            >
              asadk.dev <ExternalLink className="ml-1 w-3 h-3" />
            </a>
          </div>
        </CardFooter>
      </Card>
